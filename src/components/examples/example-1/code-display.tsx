...
export default function ExampleOneCodeBlocks() {
  ...
  useEffect(() => {
    const filePaths = {
      formCode: "src/components/examples/example-1/form.tsx",
      columnCode: "src/components/examples/example-1/column.tsx",
      tableCode: "src/components/examples/example-1/data-table.tsx",
      pageCode: "src/app/examples/page.tsx",
    };
